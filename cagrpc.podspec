#
# Be sure to run `pod lib lint cagrpc.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = "cagrpc"
  s.version          = "0.11.1"
  s.summary          = "grpc的objc版本"
  s.description      = <<-DESC
                       An optional longer description of cagrpc

                       * Markdown format.
                       * Don't worry about the indent, we strip it!
                       DESC
  s.homepage         = "https://github.com/ca-org/cagrpc.git"
  s.license          = 'MIT'
  s.author           = { "CrazyAnt" => "support@crazyant.com" }
  s.source           = { :git => "https://github.com/ca-org/cagrpc.git", :tag => s.version.to_s }

  s.platform     = :ios, '7.1'
  s.requires_arc = true


############ grpc for release-0_11_1-objectivec-0.11.1 [fa69f19] DO NOT EDIT! ############
  ...
  s.subspec 'GRPCClient' do |ss|
    ...
    ss.dependency 'cagrpc/C-Core'
    ss.dependency 'cagrpc/RxLibrary'
  ...
  s.subspec 'ProtoRPC' do |ss|
    ...
    ss.dependency 'cagrpc/GRPCClient'
    ss.dependency 'cagrpc/RxLibrary'
